        ...
        <div class="grid-container" style="display: grid; grid-template-columns: 1fr 350px; gap: 24px; margin-top: 24px;">
            ...
            <div class="main-column">
                <form id="form-missione" class="card" style="padding: 24px;">
                    ...
                    <div class="detail-section">
                        <h3 style="color: var(--accent-primary); margin-bottom: 20px;"><i class="fas fa-info-circle"></i> Dettagli Intervento</h3>
                    ...
                    <div class="detail-section" style="margin-top: 32px;">
                        <h3 style="color: var(--accent-primary); margin-bottom: 20px;"><i class="fas fa-users"></i> Gestione Team (Real-time)</h3>
                    ...
                    <div class="detail-section" style="margin-top: 32px;">
                        <h3 style="color: var(--accent-primary); margin-bottom: 20px;"><i class="fas fa-ambulance"></i> Mezzi e Attrezzature</h3>
            ...
            <div class="side-column">
                <div id="richiesta-summary" class="card" style="padding: 20px; position: sticky; top: 24px;">
                    <h3 style="font-size: 1rem; margin-bottom: 16px; border-bottom: 1px solid var(--border-color); padding-bottom: 12px;">Riepilogo Richiesta</h3>
